                        ...
                        <div className="max-w-4xl">
                            ...
                            <div className="prose prose-lg max-w-none">
                                <p className="text-gray-600 mb-6">
                                    We provide this Privacy Policy to inform users of our policies and procedures regarding the collection, use and disclosure of personally identifiable information received from users of this website, located at wanttosellhomeforcash.com ("Site").
                                </p>

                                <p className="text-gray-600 mb-6">
                                    By using our Site you are consenting to our processing of your information as set forth in this Privacy Policy now and as amended by us. "Processing" means using cookies on a computer or using or touching information in any way, including, but not limited to, collecting, storing, deleting, using, combining and disclosing information, all of which activities will take place in the United States. If you reside outside the US your personally identifiable information will be transferred to the US, and processed and stored there under US privacy standards.
                                </p>
                                ...
                                <section className="mb-8">
                                    ...
                                    <p className="text-gray-600 mb-4 font-semibold italic">
                                        "We will not share the data gathered through the opt-in process with third parties for promotional or marketing purposes"
                                    </p>
                                </section>

                                <section className="mb-8">
                                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">Information Collected Upon Registration</h2>
                                    <p className="text-gray-600 mb-4">
                                        If you desire to have access to certain restricted sections of the Site, you will be required to become a registered user, and to submit certain personally identifiable information. This happens in a number of instances, such as when you sign up for the Service, or if you desire to receive marketing materials and information. Personally identifiable information that we may collect in such instances may include your IP address, full user name, password, email address, city, time zone, telephone number, and other information that you decide to provide us with.
                                    </p>
                                </section>

                                <section className="mb-8">
                                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">Use of Contact Information</h2>
                                    <p className="text-gray-600 mb-4">
                                ...
                                <section className="mb-8">
                                    ...
                                    <p className="text-gray-600 mb-4">
                                        We use your personally identifiable information to provide the services offered on Vacant Ville, respond to inquiries, and fulfill requests.
                                    </p>

                                    <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Compliance with Laws and Law Enforcement</h3>
                                    <p className="text-gray-600 mb-4">
                                        wanttosellhomeforcash.com cooperates with government and law enforcement officials or private parties to enforce and comply with the law. We may disclose any information about you to government or law enforcement officials or private parties as we, in our sole discretion, believe necessary or appropriate to respond to claims, legal process (including subpoenas), to protect the property and rights of wanttosellhomeforcash.com or a third party, the safety of the public or any person, to prevent or stop any illegal, unethical, or legally actionable activity, or to comply with the law.
                                    </p>

                                    <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">Business Transfers</h3>
                                    <p className="text-gray-600 mb-4">
                                        wanttosellhomeforcash.com may sell, transfer or otherwise share some or all of its assets, including your personally identifiable information, in connection with a merger, acquisition, reorganization or sale of assets or in the event of bankruptcy. You will have the opportunity to opt out of any such transfer if the new entity's planned processing of your information differs materially from that set forth in this Privacy Policy.
                                    </p>
                                </section>

                                <section className="mb-8">
                                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">Changing or Deleting Information</h2>
                                    <p className="text-gray-600 mb-4">
                                        If you are a registered user of the Site, you may access and update or correct the information you provided to us. You can also submit a change by calling us at (305) 740-1132.
                                    </p>
                                </section>
